...
export const INSTRUMENTS = [
  ...
  // Europe's benchmark, priced in euros. Kept distinct from Henry Hub: they are
  // different markets, and the war in Ukraine moves this one.
  { id: 'eugas', name: 'EU gas (TTF)', group: 'Energy', provider: 'yahoo', symbol: 'TTF=F', unit: '/MWh', format: 'price' },
