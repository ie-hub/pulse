...
export const SOURCES = [
  ...
  { id: 'in-capital-chronicle', lane: 'wire', outlet: 'Indiana Capital Chronicle', kind: 'rss',
    // Publishes ~100 items where the other wire feeds carry 10–45.
    limit: 20,
    url: 'https://indianacapitalchronicle.com/feed/' },
  { id: 'mirror-indy', lane: 'wire', outlet: 'Mirror Indy',      kind: 'rss',
  ...
  { id: 'current-hc',  lane: 'wire', outlet: 'Current',          kind: 'rss',
    // Hamilton County hyperlocal — Noblesville, Carmel, Fishers, Westfield.
    url: 'https://youarecurrent.com/feed/' },
  { id: 'hc-reporter', lane: 'wire', outlet: 'Hamilton Co. Reporter', kind: 'rss',
  ...
  // neither is news.
  { id: 'noblesville',  lane: 'official', outlet: 'Noblesville',      kind: 'rss',
    url: 'https://www.noblesville.in.gov/RSSFeed.aspx?ModID=1&CID=All' },
  { id: 'noblesville-agendas', lane: 'official', outlet: 'Noblesville Agendas', kind: 'rss',
  ...
  { id: 'iedc',         lane: 'official', outlet: 'Indiana Econ Dev', kind: 'iedc',
