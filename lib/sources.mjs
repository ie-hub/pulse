...
export const SOURCES = [
  ...
  { place: 'indiana', id: 'iedc',         lane: 'official', outlet: 'Indiana Econ Dev', kind: 'iedc',
    ...
    // Five pages reaches back about five months. The global government rail
    // still shows only its newest few; the depth is for the Indiana view,
    // which is where the whole run is worth having.
    pages: 5 },
